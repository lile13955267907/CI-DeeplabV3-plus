...
class Solver(object):
    ...
    def test(self, singleImages=[], outName='35.jpg'):
        ...
        mean = np.array ([0.0903603, -2.3486707e-04, -1.4655667e-04, 0.0177745, 15.8372908, 0.6913939, 0.6046386,
        ...
        with torch.no_grad():
            ...
            cv2.imwrite('test_output/pred/{}_(1).png'.format(outName), saved_1, [int(cv2.IMWRITE_JPEG_QUALITY), 95])
            cv2.imwrite('test_output/pred/{}_(255).png'.format(outName), saved_255, [int(cv2.IMWRITE_JPEG_QUALITY), 95])
...
if __name__ == "__main__":
    ...
    config = get_yaml('ConfigFiles/config-Unet.yaml')
    print(config)

    solver = Solver(config)

    solver.test(['Data/predict/5_1_C11/35.tif',
                 'Data/predict/5_2_C12real/35.tif',
                 'Data/predict/5_3_C12imag/35.tif',
                 'Data/predict/5_4_C22/35.tif',
                 'Data/predict/5_5_alpha/35.tif',
                 'Data/predict/5_6_anisotropy/35.tif',
                 'Data/predict/5_7_entropy/35.tif',

                 'Data/predict/6_1_C11/35.tif',
                 'Data/predict/6_2_C12real/35.tif',
                 'Data/predict/6_3_C12imag/35.tif',
                 'Data/predict/6_4_C22/35.tif',
                 'Data/predict/6_5_alpha/35.tif',
                 'Data/predict/6_6_anisotropy/35.tif',
                 'Data/predict/6_7_entropy/35.tif',

                 'Data/predict/7_1_C11/35.tif',
                 'Data/predict/7_2_C12real/35.tif',
                 'Data/predict/7_3_C12imag/35.tif',
                 'Data/predict/7_4_C22/35.tif',
                 'Data/predict/7_5_alpha/35.tif',
                 'Data/predict/7_6_anisotropy/35.tif',
                 'Data/predict/7_7_entropy/35.tif',

                 'Data/predict/8_1_C11/35.tif',
                 'Data/predict/8_2_C12real/35.tif',
                 'Data/predict/8_3_C12imag/35.tif',
                 'Data/predict/8_4_C22/35.tif',
                 'Data/predict/8_5_alpha/35.tif',
                 'Data/predict/8_6_anisotropy/35.tif',
                 'Data/predict/8_7_entropy/35.tif',

                 'Data/predict/9_1_C11/35.tif',
                 'Data/predict/9_2_C12real/35.tif',
                 'Data/predict/9_3_C12imag/35.tif',
                 'Data/predict/9_4_C22/35.tif',
                 'Data/predict/9_5_alpha/35.tif',
                 'Data/predict/9_6_anisotropy/35.tif',
                 'Data/predict/9_7_entropy/35.tif'
                 ])
